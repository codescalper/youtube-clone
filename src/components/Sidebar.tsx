...
function Sidebar() {
    ...
    return (
        <div className={`w-64 transition-all duration-300 ease-in-out ${isSidebarOpen ? '' : 'w-16'}`}>
            ...
            <div className={`mb-4 text-gray-300 text-2xl font-bold ${isSidebarOpen ? '' : 'hidden'}`}>
                <p className='pb-10' >Home</p>
                <p className='pb-10' >Videos</p>
                <p className='pb-10'>Subscriptions</p>
                <p className='pb-10' >Library</p>
                <p className='pb-10'>Trending</p>
            </div>
        </div >
    );
}
